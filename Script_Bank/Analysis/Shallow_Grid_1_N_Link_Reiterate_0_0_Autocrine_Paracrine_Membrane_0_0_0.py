...
reiterate = f'Reiterate_{cellulate[0]}_{cellulate[1]}_Autocrine_Paracrine_Membrane_{_auto_para_mem}'
...
para_set_raw = {
    ...
    'chi_auto': doze[18] if auto else extrema[0],
    'chi_para': doze[19] if para else extrema[0]
}
para_set_mode = 0 # {0, 1}
