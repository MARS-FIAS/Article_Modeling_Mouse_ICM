...
initiate = {'FC_MRNA': 0, 'FC': 0} # {0, 25, 50, 100, 200} # {0, 25, 50, 75, 100, 200, 300, 400, 500, 600, 700, 800} # Toll!
_initiate = '_'.join(map(str, [f'{key}_{value}' for key, value in initiate.items()]))
reiterate = f'Reiterate_{cellulate[0]}_{cellulate[1]}_Initiate_{_initiate}'
