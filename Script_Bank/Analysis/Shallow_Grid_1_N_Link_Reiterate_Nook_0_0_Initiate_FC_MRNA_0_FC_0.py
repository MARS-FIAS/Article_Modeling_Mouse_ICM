...
initiate = {'FC_MRNA': 0, 'FC': 0} # {0, 250, 500, 750, 1000} # {0, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000} # Toll!
_initiate = '_'.join(map(str, [f'{key}_{value}' for key, value in initiate.items()]))
reiterate = f'Reiterate_Nook_{cellulate[0]}_{cellulate[1]}_Initiate_{_initiate}'
