...
card = 0 # {1, 5, 10, 25, 50}
initiate = {'MRNA': 0, 'PRO': 0} # {0, 25, 50, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 150, 175, 200, 225, 250} # Percentage!
...
faces = 2*3
species_selection = {'N_MRNA': mape[8]*initiate['MRNA']/100, 'G_MRNA': mape[8]*initiate['MRNA']/100, 'N': mape[9]*initiate['PRO']/100, 'G': mape[9]*initiate['PRO']/100} # pat
# card = 0 # {1, 5, 10, 25, 50}
seed = None # None
# sup_comp = False # True
verbose = True
