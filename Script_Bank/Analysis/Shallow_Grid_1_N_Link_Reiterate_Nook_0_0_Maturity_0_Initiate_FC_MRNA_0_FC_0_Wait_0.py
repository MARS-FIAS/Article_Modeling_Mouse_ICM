...
maturity = 48 # {48, 96}
initiate = {'FC_MRNA': 0, 'FC': 0} # {0, ..., 250} # {0, 250, 500, 750, 1000} # Toll!
_initiate = '_'.join(map(str, [f'{key}_{value}' for key, value in initiate.items()]))
wait = 0 # Hours # {0, 4, 8, 12, 16, 24, 32, 40}
reiterate = f'Reiterate_Nook_{cellulate[0]}_{cellulate[1]}_Maturity_{maturity}_Initiate_{_initiate}_Wait_{wait}'
