...
reiterate = f'Reiterate_{cellulate[0]}_{cellulate[1]}'
...
train_trials = 2 # 1
simul_trials = 50 # 100
aim_NT = [2/5] if parameter_set_rules == [0] else [1] if parameter_set_rules == [1] else None
aim_G = [3/5] if parameter_set_rules == [0] else [0] if parameter_set_rules == [1] else None
posts = list()
appraisals = list()
